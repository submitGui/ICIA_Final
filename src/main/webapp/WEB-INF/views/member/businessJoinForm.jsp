...
<script type="text/javascript">
	function BusinessJoinSubmit() {

		var Main = document.forms.business;
		opener.name = "business";
	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4">
			<div class="w3-center w3-large w3-margin-top">
				<h3>Business Join Form</h3>
			</div>
			<div>
				<form action="../member/business_member.do" method="post"
					id="business">
					<p>
						<label>ID</label> <input class="w3-input" type="text" id="userid"
							name="userid" required>
						<button type="button" id="id_check" value="id_Check">id_Check</button>
					</p>
					<p>
					...
					<p>
						<label>Company Name</label> <input type="text"
							id="member_company_name" name="member_company_name"
							class="w3-input" required placeholder="상호명을 입력해 주세요."> <span
							id="companyName" class="w3-text-red"></span>
					</p>
					<p>
						<label>Business Number<label> <input type="text"
								id="member_busiNum" name="member_busiNum" class="w3-input"
								required placeholder="사업자등록 번호를 입력해 주세요."> <span
								id="businessNumber" class="w3-text-red"></span>
					</p>
					<p>
						<label>Address</label><br /> <input type="text"
							id="sample6_postcode" class="w3-input" placeholder="우편번호">
						<input type="button" class="w3-input"
							onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
						<input type="text" id="sample6_address" placeholder="주소"
							class="w3-input" name="address" required> <input
							type="text" id="sample6_address2" placeholder="상세 주소"
							class="w3-input" name="address" required>
					</p>
					<p class="w3-center">
						<button type="submit" id="joinBtn" onclick="BusinessJoinSubmit();"
